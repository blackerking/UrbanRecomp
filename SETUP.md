...
| SDL2 | via [vcpkg](https://github.com/microsoft/vcpkg): `vcpkg install sdl2:x64-windows` | `sudo apt install libsdl2-dev` |
...
to the Visual Studio generator, as long as SDL2 dev files are discoverable.)
...
- **CMake can't find SDL2**: double-check the vcpkg toolchain file path
