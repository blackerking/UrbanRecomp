...
| 3b. Route execution through compiled bodies | **scoped, not started** — see [`docs/MIGRATION_step3.md`](docs/MIGRATION_step3.md); the blocker is a timing-model conflict, not wiring |
